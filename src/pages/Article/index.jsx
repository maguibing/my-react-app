...
import { Form, Button, Card, Breadcrumb, Radio, Select, DatePicker, Image, Tag } from 'antd'
import { Link } from 'react-router-dom'
import { EditOutlined, DeleteOutlined } from '@ant-design/icons'
import { Table, Space } from 'antd'
import { useEffect, useRef } from 'react'
import { useDispatch, useSelector } from 'react-redux'
import { getChannelList, getArticles } from '@/store/actions/article'
...
const Article = () => {
    ...
    const { channelList, results, total_count, page, per_page } = useSelector(state => state.article)
    return (
        <>
